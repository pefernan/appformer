...
package org.uberfire.collaboration.client.service;
...
public interface CollaborationSessionManager {
    ...
    void init(String uuid, CollaborationCommandFactory store, CollaborationCommandExecutor executor);

    void newCommand(InitializationContext context);
}
